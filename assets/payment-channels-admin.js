(function(){
  ...
  function defaultChannels(row){
    ...
    var online=(icon&&icon.value==='card')||/(^|\s)(cb|carte bancaire|bank card|bankkarte|visa|mastercard|card)(\s|$)/i.test(text);
  ...
  function enhance(row){
    ...
    legend.textContent='Canaux acceptés';
    field.appendChild(legend);

    var choices=document.createElement('div');
    choices.className='htp-check-list';
    ...
    var grid=row.querySelector('.htp-grid');
