...
final class Parcs_HT_Verifier {
    ...
    public static function save_languages($new_value, $old_value, $option) {
        ...
        if (!$authorized || !isset($_POST['parcs_ht_languages_present'])) {
