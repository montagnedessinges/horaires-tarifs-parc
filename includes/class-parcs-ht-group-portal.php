        ...
        <div id="<?php echo esc_attr($id); ?>" class="parcs-ht-group-portal" data-group-portal>
            <?php if ($has_tariffs || $has_hours) : ?>
                <div class="parcs-ht-group-portal-tabs" role="tablist">
                    <?php if ($has_tariffs) : ?>
                        <button type="button" class="<?php echo $default_tab === 'tariffs' ? 'is-active' : ''; ?>" data-group-main-tab="tariffs" aria-selected="<?php echo $default_tab === 'tariffs' ? 'true' : 'false'; ?>"><?php echo esc_html(self::text($language, 'Tarifs groupes', 'Group rates', 'Gruppentarife')); ?></button>
                    <?php endif; ?>
                    <?php if ($has_hours) : ?>
                        <button type="button" class="<?php echo $default_tab === 'hours' ? 'is-active' : ''; ?>" data-group-main-tab="hours" aria-selected="<?php echo $default_tab === 'hours' ? 'true' : 'false'; ?>"><?php echo esc_html(self::text($language, 'Horaires d’ouverture', 'Opening hours', 'Öffnungszeiten')); ?></button>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
