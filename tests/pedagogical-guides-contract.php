...
guide_contract(strpos($php, 'parcs-ht-guide-card-top') !== false && strpos($php, 'parcs-ht-guide-description') !== false, 'Guide card keeps a dedicated top block and description content');
...
guide_contract(strpos($php, '144 × 192 px sur ordinateur') !== false && strpos($php, '96 × 128 px sur mobile') !== false, 'Admin shows the compact desktop and mobile display sizes');
...
guide_contract(strpos($css, '.parcs-ht-guides-label{') !== false && strpos($css, 'font-size:1.75rem') !== false, 'Desktop guide section title is visually prominent');
...
guide_contract(strpos($css, 'padding:16px 16px 16px 178px') !== false && strpos($css, 'position:absolute;left:16px;top:16px;width:144px;height:192px') !== false, 'Desktop guide card reserves a compact left cover while content starts immediately beside it');
...
guide_contract(strpos($css, '.parcs-ht-guide-actions{display:flex;flex-wrap:wrap;justify-content:flex-start') !== false && strpos($css, 'width:auto!important') !== false, 'Desktop guide actions stay grouped naturally instead of spreading across the card');
guide_contract(strpos($css, '.parcs-ht-guide-description{margin:12px 0 0') !== false, 'Desktop description follows the title immediately without a full-width blank band');
