...
htp_1173_assert(strpos($schedule, "calendar_closed_bg_color") !== false && strpos($schedule, "calendar_selected_color") !== false, 'couleurs fonctionnelles du calendrier non conservées');
