...
foreach (array(
    'Administration générale', 'Parc', 'Saisons', 'Publication de l’année sélectionnée',
...
htp_admin_1171_assert(strpos($general, 'delete_option(') === false, 'Administration générale ne doit supprimer aucune option');
htp_admin_1171_assert(strpos($appearance_admin, 'delete_option(') === false, 'L’éditeur d’apparence ne doit supprimer aucune option');
