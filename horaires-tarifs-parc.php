...
define('PARCS_HT_VERSION', '1.17.11');
...
require_once PARCS_HT_DIR . 'includes/class-parcs-ht-group-quote-state-normalizer.php';
require_once PARCS_HT_DIR . 'includes/class-parcs-ht-group-tariff-switch-admin.php';
...
require_once PARCS_HT_DIR . 'includes/class-parcs-ht-tariff-shared-1168.php';
...
require_once PARCS_HT_DIR . 'includes/class-parcs-ht-stability-11511.php';
...
Parcs_HT_Group_Quote_State_Normalizer::init();
...
add_action('plugins_loaded', static function () {
    ...
    Parcs_HT_Shortcode_Composer::init();
    Parcs_HT_Tariff_Public_Fixes::init();
    Parcs_HT_Tariff_Shared_1168::init();
